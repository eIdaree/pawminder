  ...
  return (
    <View className="flex-1 justify-center px-5 py-5 bg-gray-100">
      <View>
        ...
        <Text className=" text-gray-400 text-left mb-5">Create an account to continue!</Text>
      </View>
      <TextInput
      ...
      <View className="mb-3">
        <TouchableOpacity onPress={toggleDatePicker} className="h-12 border border-gray-300 rounded-lg px-3 flex justify-center bg-white">
          <Text className="text-gray-600">{dob ? dob.toLocaleDateString() : 'Select Date'}</Text>
        </TouchableOpacity>
        {isDatePickerVisible && (
          <DateTimePicker
            value={dob || new Date()}
      ...
      <TouchableOpacity onPress={handleSignUp} className="bg-indigo-500 py-3 rounded-lg mb-4">
