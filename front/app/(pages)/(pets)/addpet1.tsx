// Начнём с рефакторинга формы AddPet с использованием react-hook-form на всех шагах.
// Добавим универсальные Controller-ы и уберём дублирование.
// Все поля будут валидироваться через yup + react-hook-form.

// Файл будет слишком длинным для одного сообщения, поэтому я разделю его на логические части и отправлю первую часть сейчас — базовая структура и первые шаги (1-3).
